...
2.) Two Ways of Identifying locators on webview 
   i) open chrome browser and type "chrome://inspect/#devices" 
   ii) Use Browser inspectors 
"""
desired_caps = {}
...
# open google chrome in the emulator
# in the cmd >> adb shell dumpsys window windows >> top app >> copy app packagr and app activity
